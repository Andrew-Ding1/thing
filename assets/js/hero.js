...
const ocean = {
  ...
  <p>I begun my exploration at 16 as I worked as a lab assistant at the University of Chicago researching cardiovascular dysfunction, co-authoring an abstract on the topic 2 years later. Now, I challenge my brain with analytical issues through my Philosophy degree while keeping up my love for STEM, picking up work at a decentralized organization built on synthetic biology called ValleyDAO. 
  This gave me a proper introduction to the world of Web3, as well as an opportunity to practice the computer science that I had been self-teaching, including everything from back-end
    </p`,
  creds: "<p>AI+Web3 | Phil+CS @ UCSD | Data Sci @ ValleyDAO</p>",
  email: " <p>Email: ocfang@ucsd.edu</p> ",
  content: `
  <p><strong>Kinin B1R Inhibitor Prevents Sepsis-Induced Cardiac Dysfunction and Promotes Survival in Mice</strong></p>

  <p><strong>Medical Profession Return on Investment Analysis</strong></p>
  
  <p><strong>Identifying Entrepreneurialy Active Synthetic Biology Researchers</strong></p>
  
  <p><strong>Cell Passage Number Analysis on Hypothermia Induced Cells.</strong></p>
